  ...
  return [
    {
      ...
      body: surplus
        ...
        : gap === undefined
          ...
          : `Nearly every council says this every year. It is a plan, not money missing from the bank. The law says they cannot plan to spend more than they get. So the gap always gets closed. Usually that is partly your council tax.`,
