...
export const sources: Source[] = [
  ...
  },
  {
    ...
    publisher: "Valuation Office Agency / UK Government",
    url: "https://www.gov.uk/government/publications/local-housing-allowance-lha-rates-applicable-from-april-2026-to-march-2027",
    used: "Confirmation that 2026–27 Local Housing Allowance rates carry forward the April 2024 cash rates and exclude newer 2025 rent evidence from the calculation.",
  },
  {
    id: "mini-budget-2022",
