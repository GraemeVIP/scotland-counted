    ...
    <>
      ...
      <Page>
        <PageHeader
          ...
          title="Privacy"
          lede="This site is built to need as little from you as possible. There is no tracking, no analytics, no advertising and no profiling. This page says exactly what is collected, when, and how to have it removed."
        />
