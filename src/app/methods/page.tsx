          ...
          <ol className="space-y-6 max-w-[78ch]">
            {sources.map((s, i) => (
              <li key={s.id} className="grid grid-cols-[2rem_1fr] gap-3">
                <span className="font-mono text-[12px] text-[var(--muted)] pt-1 tnum">
                ...
                <div>
                  ...
                  <p className="font-mono text-[11.5px] text-[var(--muted)] mt-0.5 mb-1.5">
                    {s.publisher}
                  </p>
                  ...
                  {s.derivation && (
                    <p className="text-[14.5px] text-[var(--ink-2)] leading-[1.55] mt-1.5 pl-3 border-l-2 border-[var(--rule)]">
                      <span className="font-mono text-[10.5px] uppercase tracking-[0.07em] text-[var(--muted)] block mb-0.5">
                        Our derivation
                      </span>
                      {s.derivation}
                    </p>
